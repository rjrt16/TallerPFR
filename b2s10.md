...
object Problema1B2S10 extends App{

  val listaN = Var(List(5,10,15,20))

  val suma = Signal{listaN.value.sum}

  val observador = suma.observe{nSuma =>
  println(s"Suma actual:  $nSuma")}

  listaN.set(listaN.now :+ 10)
  listaN.set(listaN.now :+ 20)
}

```
<img width="1910" height="1019" alt="image" src="https://github.com/user-attachments/assets/9ccc0b00-a61d-434a-bdcc-df0bf6829e96" />
...
object Problema2B2S10 extends App{
...
val observador = energiaCinetica.observe{r =>
  println(s"Energia Cinetica:  $r")
  if(r > 1000000){
    println("ALERT: Energia cinetica muy alta, reduzca la velocidad")
  }
}
velocidad.set(50)
...
<img width="1918" height="1078" alt="image" src="https://github.com/user-attachments/assets/723492e2-a423-4593-9427-ad279f0041b0" />
