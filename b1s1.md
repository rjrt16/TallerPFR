...
main :: IO ()
main = print (getAverage [1, 2, 3, 4, 5])
...
@main def run(): Unit =
  val nums = List(1, 2, 3, 4, 5)
  println(getAverage(nums)) // 3.0

![alt text](image-2.png)


Respueta: 
Para mi la forma mas sencilla de entender fue scala, puesto que necesitamos menos lineas de codigo que entender y es mas facil de leer.
### Calificación:
